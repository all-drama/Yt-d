    ...
    if st.button("Extract Video URL"):
        if url:
            ...
            if video_url:
                ...
                st.markdown(f'<p style="text-align:center;font-size:18px;"><a href="{video_url}" target="_blank" style="color:blue;text-decoration:none;">Download Video</a></p>', unsafe_allow_html=True)
