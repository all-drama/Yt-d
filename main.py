                ...
                st.markdown(
                    ...
                    <div style="text-align:center;">
                        <a href="{video_url}" target="_blank">
                            <button style="font-size:18px;padding:10px;background-color:#f1f1f1;box-shadow:0px 0px 10px 3px #f1f1f1;border-radius:10px;">
                                <span style="color:#0000FF;text-decoration:none;text-shadow: 2px 2px 8px #0000FF;">
                                    Download Video
                                </span>
                            </button>
                        </a>
