...
def playlist(url):
    ...
    st.info(f'Number of videos in playlist: {len(playlist_obj.video_urls)}', icon="ℹ️")
...
def channel(url):
    ...
    st.info(f'Downloading videos from channel: {channel_videos.channel_name}', icon="ℹ️")
